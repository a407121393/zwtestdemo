...
public class CalendarView extends View implements View.OnTouchListener {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//surface.height = getResources().getDisplayMetrics().heightPixels;
...
//		canvas.drawRect(surface.weekHeight, surface.width, surface.weekHeight, surface.width, surface.cellBgPaint);
	...
	private void setSelectedDateByCoor(float x, float y) {
		// change month
		Log.d(TAG,"surface.monthHeight:"+surface.monthHeight+" surface.monthChangeWidth:"+ surface.monthChangeWidth);
...
//				}
	...
	private class Surface {
		...
		public void init() {
			...
			monthHeight = (float) ((temp + temp * 0.3f) * 0.8);
